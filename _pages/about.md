...
In a time when we can ask ChatGPT to build complicated things and absolve us of the responsibility to learn and understand how to do it ourselves, I have chosen to let time constraints and the limits of my own technical abilities breed creativity. This project has succeeded in no small part thanks to the very human communities established around Twine <a href="https://twinery.org/cookbook/" target="_blank">here</a> and <a href="https://intfiction.org/c/authoring/twine/46" target="_blank">here</a>. When so much of the digital world is behind a paywall, this project is a testament to the free and open-source tools that still enable independent work and creative projects of all kinds.
